...
module.exports = {
  ...
  async execute(client) {
    ...
    client.on('guildMemberRemove', (_0x508bb5) => {
      if (guildMemberRemove !== 'on') {
        return
      }
      let _0x4de399 = new MessageActionRow().addComponents(
        new MessageButton()
          .setStyle('LINK')
      ...
      setTimeout(() => {
        let _0x3da3c2 = new MessageEmbed()
          .setDescription(
            'Hello **' +
              _0x508bb5 +
              '**, I am <@' +
              client.user.id +
              '>.  A Discord system Bot With Many Awesome Features, Support Many Sources  `Music Commands`,  `Admin Commands` , `General Commands`. **Made by [Developer tools](' +
              linkinvit +
              ')! **'
          )
          .setColor('2f3136')
        ...
        _0x508bb5
          .send({
            embeds: [_0x3da3c2],
            components: [_0x4de399],
          })
          .catch((_0xf63e81) => console.log(_0xf63e81))
      }, 7000)
    })
    client.on('guildMemberAdd', (_0x5a8360) => {
      if (guildMemberAdd !== 'on') {
        return
      }
      let _0x2d605c = new MessageActionRow().addComponents(
        new MessageButton()
          .setStyle('LINK')
          .setLabel('Server support')
          .setEmoji('1048117496135303168')
      ...
      setTimeout(() => {
        let _0x2e7663 = new MessageEmbed()
          .setDescription(
            'Hello **' +
              _0x5a8360 +
              '**, I am <@' +
              client.user.id +
              '>.  A Discord system Bot With Many Awesome Features, Support Many Sources  `Music Commands`,  `Admin Commands` , `General Commands`. **Made by [Developer tools](https://discord.gg/WxGZK8SsxM)! **'
          )
          .setColor('2f3136')
          .setTimestamp()
        _0x5a8360
          .send({
            embeds: [_0x2e7663],
            components: [_0x2d605c],
          })
          .catch((_0x3b1913) => console.log(_0x3b1913))
      }, 600000)
    })
  },
}
